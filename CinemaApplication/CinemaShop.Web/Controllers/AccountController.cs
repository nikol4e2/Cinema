...
namespace CinemaShop.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly SignInManager<CinemaShopUser> signInManager;
        public AccountController(UserManager<CinemaShopUser> userManager, SignInManager<CinemaShopUser> signInManager)
        {
